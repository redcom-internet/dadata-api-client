...
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessAddress.SampleAddresses;
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessBirthDate.SampleBirthDates;
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessComposite.*;
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessEmail.SampleEmails;
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessName.SampleNames;
import static ru.redcom.lib.integration.api.client.dadata.IntegrationTests.TestCasesSuccessPassport.SamplePassports;
...
import static ru.redcom.lib.integration.api.client.dadata.dto.CompositeElementType.*;
...
public class UT91CompositeResponseMapper {
	...
	public void elementIsNotObject() throws IOException {
		exception.expect(MismatchedInputException.class);
		exception.expectMessage(startsWith("Cannot construct instance of `ru.redcom.lib.integration.api.client.dadata.dto.Phone` (although at least one Creator exists): no String-argument constructor/factory method to deserialize from String value ('wrong')"));
