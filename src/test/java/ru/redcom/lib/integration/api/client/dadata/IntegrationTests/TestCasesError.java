...
import ru.redcom.lib.integration.api.client.dadata.APIErrorCode;
...
import static ru.redcom.lib.integration.api.client.dadata.APIErrorCode.*;
...
*/
	...
	private static Matcher<DaDataException> matcherEmptyResponse4() {
		return allOf(hasProperty("cause", instanceOf(RestClientException.class)),
		             hasProperty("cause", hasProperty("message", is("Error while extracting response for type [class [Lru.redcom.lib.integration.api.client.dadata.dto.Address;] and content type [application/json]; nested exception is org.springframework.http.converter.HttpMessageNotReadableException: JSON parse error: Cannot deserialize instance of `ru.redcom.lib.integration.api.client.dadata.dto.Address[]` out of START_OBJECT token; nested exception is com.fasterxml.jackson.databind.exc.MismatchedInputException: Cannot deserialize instance of `ru.redcom.lib.integration.api.client.dadata.dto.Address[]` out of START_OBJECT token\n at [Source: (ByteArrayInputStream); line: 1, column: 1]"))),
		             hasProperty("fatal", is(false)));
	}

	private static Matcher<DaDataException> matcherEmptyResponse5() {
		return allOf(hasProperty("cause", instanceOf(RestClientException.class)),
		             hasProperty("cause", hasProperty("message", is("Error while extracting response for type [class [Lru.redcom.lib.integration.api.client.dadata.dto.Address;] and content type [application/json]; nested exception is org.springframework.http.converter.HttpMessageNotReadableException: JSON parse error: Cannot construct instance of `ru.redcom.lib.integration.api.client.dadata.dto.Address` (although at least one Creator exists): no String-argument constructor/factory method to deserialize from String value (''); nested exception is com.fasterxml.jackson.databind.exc.MismatchedInputException: Cannot construct instance of `ru.redcom.lib.integration.api.client.dadata.dto.Address` (although at least one Creator exists): no String-argument constructor/factory method to deserialize from String value ('')\n at [Source: (ByteArrayInputStream); line: 1, column: 2] (through reference chain: java.lang.Object[][0])"))),
		             hasProperty("fatal", is(false)));
	}
	...
	private static Matcher<DaDataClientException> matcherWrongErrorResponse() {
		...
		return allOf(hasProperty("httpStatusCode", is(400)),
		             ...
		             hasProperty("suppressed", allOf(arrayContaining(instanceOf(RestClientException.class)),
		                                             arrayContainingInAnyOrder(hasProperty("message", is("Error while extracting response for type [class ru.redcom.lib.integration.api.client.dadata.dto.APIErrorMessage] and content type [application/json]; nested exception is org.springframework.http.converter.HttpMessageNotReadableException: JSON parse error: Unexpected end-of-input: expected close marker for Object (start marker at [Source: (ByteArrayInputStream); line: 1, column: 1]); nested exception is com.fasterxml.jackson.core.io.JsonEOFException: Unexpected end-of-input: expected close marker for Object (start marker at [Source: (ByteArrayInputStream); line: 1, column: 1])\n" +
